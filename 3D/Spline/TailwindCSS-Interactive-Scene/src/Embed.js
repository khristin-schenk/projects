							...
							<div className="mx-auto max-w-md px-4 max-w-2xl px-6 text-center">
								<div className="">
									<a href="#" className="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 text-base hover:text-gray-200">
										...
										<span className="ml-4 text-sm">Front-End Developer</span>
										<ChevronRightIcon className="ml-2 w-5 h-5 text-gray-500" aria-hidden="true" />
									</a>
									<h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white mt-5 text-6xl">
										<span className="block">Khristin</span>
										<span className="block text-indigo-400">Schenk</span>
									</h1>
									<p className="mt-3 text-base text-gray-300 mt-5 text-xl">
										Exploring opportunities to create accessible experiences in Augmented and Virtual Reality.
									</p>
											...
											<div className="flex">
												<div className="min-w-0 flex-1">
													...
													<input
														...
														className="hidden block w-full px-4 py-3 rounded-md border-0 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900"
													/>
												</div>
