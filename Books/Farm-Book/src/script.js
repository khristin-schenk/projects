...
import * as modernizr from "https://cdn.skypack.dev/modernizr@3.11.8";
import threeTrackballcontrols from "https://cdn.skypack.dev/three-trackballcontrols@0.9.0";
Modernizr.load({
  test: Modernizr.csstransforms3d,
  yep: {
    traqball: "js/traqball.js"
  },
  nope: "js/traqball_alternative.js",
  callback: {
